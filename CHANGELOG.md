...
- Fixed E2E tests failing with `__dirname is not defined in ES module scope` by using `import.meta.url` in `e2e/helpers.ts` ([#14](https://github.com/emanuelen5/smart-privacy/pull/14))
